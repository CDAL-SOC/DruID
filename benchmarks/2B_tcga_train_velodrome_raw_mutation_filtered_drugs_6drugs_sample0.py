...
class arguments():
    def __init__(self):
        ...
        self.epoch = 30
        self.gpu = 0
        self.save_logs = f"../data/model_checkpoints/tcga_velodrome_logs_raw_mutations_filtered_drugs_6_sample{sample_id}/"
        self.save_models = f"../data/model_checkpoints/tcga_velodrome_models_raw_mutations_filtered_drugs_6_sample{sample_id}/"
        self.save_results = f"../data/model_checkpoints/tcga_velodrome_results_raw_mutations_filtered_drugs_6_sample{sample_id}/"
...
class TrainVelodrome():
    def __init__(self, args=args):
        ...
        tcga_train_mut_df = tcga_train.raw_mutations[tcga_train.raw_mutations.index.isin(tcga_train_drug_specific_df.submitter_id)]
        ...
        for drug_name in unique_drugs:
            ...
            train_mut_df = cl_dataset_train.raw_mutations[cl_dataset_train.raw_mutations.index.isin(train_drug_specific_df.depmap_id)]
            ...
            test_mut_df = cl_dataset_test.raw_mutations[cl_dataset_test.raw_mutations.index.isin(test_drug_specific_df.depmap_id)]
