...
# From https://github.com/hosseinshn/Velodrome
...
class arguments():
    def __init__(self):
        ...
        self.epoch = 30
        self.gpu = 0
        self.save_logs = f"../data/model_checkpoints/tcga_velodrome_logs_raw_mutations_wes_filtered_drugs_6_sample{sample_id}/"
        self.save_models = f"../data/model_checkpoints/tcga_velodrome_models_raw_mutations_wes_filtered_drugs_6_sample{sample_id}/"
        self.save_results = f"../data/model_checkpoints/tcga_velodrome_results_raw_mutations_wes_filtered_drugs_6_sample{sample_id}/"
...
class TrainVelodrome():
    def __init__(self, args=args):
        ...
        tcga_train_mut_df = tcga_train.embedded_raw_mutations_all_genes_v2[tcga_train.embedded_raw_mutations_all_genes_v2.index.isin(tcga_train_drug_specific_df.submitter_id)]
        tcga_train_mut_df.index.name = "submitter_id"
        ...
        for drug_name in unique_drugs:
            ...
            train_mut_df = cl_dataset_train.embedded_raw_mutations_all_genes_v2[cl_dataset_train.embedded_raw_mutations_all_genes_v2.index.isin(train_drug_specific_df.depmap_id)]
            train_mut_df.index.name = "depmap_id"
            ...
            test_mut_df = cl_dataset_test.embedded_raw_mutations_all_genes_v2[cl_dataset_test.embedded_raw_mutations_all_genes_v2.index.isin(test_drug_specific_df.depmap_id)]
            test_mut_df.index.name = "depmap_id"
